      ...
      <Card>
        ...
        <div style={{ marginBottom: 16 }}><SectionTitle>Identifikasi</SectionTitle>
          <Grid2>
            ...
            <Field label="SRG Number" id="srg" value={form.srg} onChange={set('srg')} placeholder="00900205260012" />
            <Field label="No. Seri" id="serial" value={form.serial} onChange={set('serial')} placeholder="AN015812" />
            <Field label="PHJ Number" id="phj" value={form.phj} onChange={set('phj')} placeholder="014/DIR/API-KBI/V/2026" />
          </Grid2>
        </div>
        ...
        <div style={{ marginBottom: 16 }}><SectionTitle>Commodity & Warehouse</SectionTitle>
          <Grid3>
            ...
            <Field label="Grade / remarks" id="grade" value={form.grade} onChange={set('grade')} placeholder="Robusta Grade 6" />
          </Grid3>
        </div>
        ...
        <div style={{ marginBottom: 16 }}><SectionTitle>Struktur pinjaman (auto-kalkulasi)</SectionTitle>
          <Grid3>
            ...
            <Field label="Tenor (months)" id="tenor" type="number" value={form.tenor} onChange={set('tenor')} placeholder="1" />
        ...
        <div style={{ marginBottom: 16 }}><SectionTitle>Dates & fees</SectionTitle>
          <Grid2>
            ...
            <Field label="Insurance Fidelity (IDR)" id="insFid" type="number" value={form.insFid} onChange={set('insFid')} placeholder="11532250" />
            <Field label="Admin fee (IDR) — API income" id="adminFee" type="number" value={form.adminFee} onChange={set('adminFee')} placeholder="1142225" />
